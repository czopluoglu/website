...
secimturu      = 2      # ilce belediye

buyuksehir.kod <- fromJSON("https://sonuc.ysk.gov.tr/api/getIlList?secimId=36039&secimTuru=2&sandikTuru=-1&yurtIciDisi=1")
...
parti.kod <- jsonlite::fromJSON("https://sonuc.ysk.gov.tr/api/getSandikSecimSonucBaslikList?secimId=36039&secimCevresiId=0&ilId=0&bagimsiz=0&secimTuru=2&yurtIciDisi=1")
...
colnames(sandik.sonuc)[8:38] <- paste0(colnames(sandik.sonuc)[8:38],"_IlceBLB2014")

write.csv(sandik.sonuc,"IlceBLB2014.csv",row.names=FALSE)
