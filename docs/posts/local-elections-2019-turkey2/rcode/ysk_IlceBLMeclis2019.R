...
#2019 Ilce Belediye Meclis Uyeligi
...
parti.kod <- jsonlite::fromJSON("https://sonuc.ysk.gov.tr/api/getSandikSecimSonucBaslikList?secimId=49302&secimCevresiId=0&ilId=0&bagimsiz=0&secimTuru=3&yurtIciDisi=1")
...
colnames(sandik.sonuc)[8:27] <- paste0(colnames(sandik.sonuc)[8:27],"_IlceBLMeclis2019")

write.csv(sandik.sonuc,"IlceBLMeclis2019.csv",row.names=FALSE)
