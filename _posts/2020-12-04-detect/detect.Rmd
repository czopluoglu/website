...
```{r echo=FALSE}
xfun::embed_file(here('_posts/2020-12-04-detect/data/ipar.csv'))
```
...
```{r echo=FALSE}
xfun::embed_file(here('_posts/2020-12-04-detect/test/detect4.exe'))
```

&nbsp;

```{r echo=FALSE}
xfun::embed_file(here('_posts/2020-12-04-detect/test/detect4.for'))
```
...
include_url(here('_posts/2020-12-04-detect/data/detect.in'), height = "500px")
```


```{r echo=FALSE}
xfun::embed_file(here('_posts/2020-12-04-detect/data/detect.in'))
```
...
```{r echo=FALSE}
xfun::embed_file(here('_posts/2020-12-04-detect/test/resp.dat'))
```
...
```{r echo=FALSE, eval=TRUE}
include_url(here('_posts/2020-12-04-detect/test/resp.out'), height = "500px")
```

```{r echo=FALSE}
xfun::embed_file(here('_posts/2020-12-04-detect/test/resp.out'))
```
...
```{r echo=FALSE, eval=TRUE}
include_url(here('_posts/2020-12-04-detect/test/detect.in'), height = "500px")
```
...
```{r echo=FALSE, eval=TRUE}
include_url(here('_posts/2020-12-04-detect/test/rep1.out'), height = "500px")
```
