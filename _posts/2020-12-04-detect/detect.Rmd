...
[Download the item parameter file](/_posts/2020-12-04-detect/data/ipar.csv)
...
[Download the detect4.exe file](/_posts/2020-12-04-detect/test/detect4.exe)

&nbsp;

[Download the Fortran source file for the detect4.exe file](/_posts/2020-12-04-detect/test/detect4.for)
...
include_url('data/detect.in', height = "500px")
```

[Download the DETECT input file](/_posts/2020-12-04-detect/data/detect.in)
...
[Download the simulated dataset](/_posts/2020-12-04-detect/test/resp.dat)
...
```{r echo=FALSE, eval=TRUE}
include_url('test/resp.out', height = "500px")
```

[Download the DETECT output file](/_posts/2020-12-04-detect/test/resp.out)
...
```{r echo=FALSE, eval=TRUE}
include_url('test/detect.in', height = "500px")
```
...
```{r echo=FALSE, eval=TRUE}
include_url('test/rep1.out', height = "500px")
```
